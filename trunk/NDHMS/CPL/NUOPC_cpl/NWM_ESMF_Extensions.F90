...
module NWM_ESMF_Extensions
  ...
  public :: NWM_ESMF_GridWrite
  public :: NWM_ESMF_MAPPRESET_GLOBAL
  public :: NWM_ESMF_MAPPRESET_CONUS
  public :: NWM_ESMF_MAPPRESET_IRENE
  public :: NWM_ESMF_MAPPRESET_FRONTRANGE
  public :: NWM_ESMF_FieldFill
  public :: NWM_ESMF_FillField
  public :: NWM_ESMF_FillArray
  public :: NWM_ESMF_FillFieldBundle
  public :: NWM_ESMF_FillState
  public :: NWM_ESMF_NetcdfReadIXJX
  public :: NWM_ESMF_NetcdfIsPresent
  public :: NWM_ESMF_LogStateList
  public :: NWM_ESMF_LogState
  public :: NWM_ESMF_LogFieldConnections
  public :: NWM_ESMF_LogGrid
  public :: NWM_ESMF_LogFieldList
  public :: NWM_ESMF_LogField
  public :: NWM_ESMF_LogFieldLclVal
  public :: NWM_ESMF_LogArrayLclVal
  public :: NWM_ESMF_LogFarrayLclVal
  public :: NWM_ESMF_LogCplList
...
!==============================================================================
  ...
  interface NWM_ESMF_GridWrite
    module procedure NWM_ESMF_GridWrite_coords
    module procedure NWM_ESMF_GridWrite_preset
    module procedure NWM_ESMF_GridWrite_default
  end interface

  interface NWM_ESMF_NclScriptWrite
    module procedure NWM_ESMF_NclScriptWrite_coords
    module procedure NWM_ESMF_NclScriptWrite_preset
    module procedure NWM_ESMF_NclScriptWrite_default
  end interface

  interface NWM_ESMF_FerretScriptWrite
    module procedure NWM_ESMF_FerretScriptWrite_coords
    module procedure NWM_ESMF_FerretScriptWrite_preset
    module procedure NWM_ESMF_FerretScriptWrite_default
  end interface

  interface NWM_ESMF_FillState
    module procedure NWM_ESMF_FillState_I4
    module procedure NWM_ESMF_FillState_I8
    module procedure NWM_ESMF_FillState_R4
    module procedure NWM_ESMF_FillState_R8
    module procedure NWM_ESMF_FillState_SCHEME
  end interface

  interface NWM_ESMF_FillFieldBundle
    module procedure NWM_ESMF_FillFieldBundle_I4
    module procedure NWM_ESMF_FillFieldBundle_I8
    module procedure NWM_ESMF_FillFieldBundle_R4
    module procedure NWM_ESMF_FillFieldBundle_R8
    module procedure NWM_ESMF_FillFieldBundle_SCHEME
  end interface

  interface NWM_ESMF_FillField
    module procedure NWM_ESMF_FillField_I4
    module procedure NWM_ESMF_FillField_I8
    module procedure NWM_ESMF_FillField_R4
    module procedure NWM_ESMF_FillField_R8
  end interface

  interface NWM_ESMF_FillArray
    module procedure NWM_ESMF_FillArray_I4
    module procedure NWM_ESMF_FillArray_I8
    module procedure NWM_ESMF_FillArray_R4
    module procedure NWM_ESMF_FillArray_R8
  end interface

  interface NWM_ESMF_NetcdfReadIXJX
    module procedure NWM_ESMF_NetcdfReadIXJX_Field
    module procedure NWM_ESMF_NetcdfReadIXJX_Array
    module procedure NWM_ESMF_NetcdfReadIXJX_I4
    module procedure NWM_ESMF_NetcdfReadIXJX_I8
    module procedure NWM_ESMF_NetcdfReadIXJX_R4
    module procedure NWM_ESMF_NetcdfReadIXJX_R8
  end interface

  interface NWM_ESMF_LogFarrayLclVal
    module procedure NWM_ESMF_LogFarrayLclVal_I41D
    module procedure NWM_ESMF_LogFarrayLclVal_I42D
    module procedure NWM_ESMF_LogFarrayLclVal_I43D
    module procedure NWM_ESMF_LogFarrayLclVal_I81D
    module procedure NWM_ESMF_LogFarrayLclVal_I82D
    module procedure NWM_ESMF_LogFarrayLclVal_I83D
    module procedure NWM_ESMF_LogFarrayLclVal_R41D
    module procedure NWM_ESMF_LogFarrayLclVal_R42D
    module procedure NWM_ESMF_LogFarrayLclVal_R43D
    module procedure NWM_ESMF_LogFarrayLclVal_R81D
    module procedure NWM_ESMF_LogFarrayLclVal_R82D
    module procedure NWM_ESMF_LogFarrayLclVal_R83D
  end interface
...
!==============================================================================
  ...
  type(MapDesc),parameter :: &
    NWM_ESMF_MAPPRESET_GLOBAL = MapDesc("GLOBAL",.TRUE.,-90.0,90.0,-180.0,-180.0), &
    NWM_ESMF_MAPPRESET_CONUS = MapDesc("CONUS",.FALSE.,18.0,49.0,235.0,298.0), &
    NWM_ESMF_MAPPRESET_IRENE = MapDesc("IRENE",.FALSE.,10.0,60.0,240.0,320.0), &
    NWM_ESMF_MAPPRESET_FRONTRANGE = MapDesc("FRONTRANGE",.FALSE.,38.5,41.0,-107.0,-103.5)
...
contains
  ...
  !-----------------------------------------------------------------------------
#define METHOD "NWM_ESMF_GridWrite"
!BOP
! !IROUTINE: NWM_ESMF_GridWrite - Write Grid data to file
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_GridWrite
  subroutine NWM_ESMF_GridWrite_coords(grid, nclScript, mapName, minCoords, &
...
!EOP
  !-----------------------------------------------------------------------------
    ...
    call NWM_ESMF_GridWrite(grid, fileName=fileName, overwrite=overwrite, &
...
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_GridWrite
  subroutine NWM_ESMF_GridWrite_preset(grid, nclScript, mapPreset, &
    ...
    select case (trim(mapPreset))
      case ('global','GLOBAL','Global')
        call NWM_ESMF_GridWrite(grid, fileName=fileName, overwrite=overwrite, &
          ...
          nclScript=nclScript, map=NWM_ESMF_MAPPRESET_GLOBAL, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      case ('conus','CONUS','Conus')
        call NWM_ESMF_GridWrite(grid, fileName=fileName, overwrite=overwrite, &
          timeslice=timeslice, iofmt=iofmt, relaxedflag=relaxedflag, &
          nclScript=nclScript, map=NWM_ESMF_MAPPRESET_CONUS, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      case ('irene','IRENE','Irene')
        call NWM_ESMF_GridWrite(grid, fileName=fileName, overwrite=overwrite, &
          timeslice=timeslice, iofmt=iofmt, relaxedflag=relaxedflag, &
          nclScript=nclScript, map=NWM_ESMF_MAPPRESET_IRENE, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      case ('frontrange','FRONTRANGE','FrontRange')
        call NWM_ESMF_GridWrite(grid, fileName=fileName, overwrite=overwrite, &
          timeslice=timeslice, iofmt=iofmt, relaxedflag=relaxedflag, &
          nclScript=nclScript, map=NWM_ESMF_MAPPRESET_FRONTRANGE, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      case default
...
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_GridWrite
  subroutine NWM_ESMF_GridWrite_default(grid, fileName, overwrite, status, &
    ...
    if (doItFlag) then
      ...
      if (lnclScript) then
        ...
        if (coordDimMax == 1) then
          call NWM_ESMF_NclScriptWrite(gridFile=lfileName, map=map, &
...
#define METHOD "NWM_ESMF_NclScriptWrite"
!BOP
! !IROUTINE: NWM_ESMF_NclScriptWrite_coords - Write NCL Script to file
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_NclScriptWrite
  subroutine NWM_ESMF_NclScriptWrite_coords(gridFile,mapName,minCoords,maxCoords, &
...
!EOP
  !-----------------------------------------------------------------------------
    ...
    call NWM_ESMF_NclScriptWrite(gridFile, map=map, title=title, &
...
#define METHOD "NWM_ESMF_NclScriptWrite"
!BOP
! !IROUTINE: NWM_ESMF_NclScriptWrite_preset - Write NCL Script to file
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_NclScriptWrite
  subroutine NWM_ESMF_NclScriptWrite_preset(gridFile,mapPreset, &
  title,nclFile,uniformRect,writeCorners,rc)
! ! ARGUMENTS
    character(len=*),intent(in)          :: gridFile
    character(len=*),intent(in)          :: mapPreset
...
!EOP
  !-----------------------------------------------------------------------------
    ...
    select case (trim(mapPreset))
      case ('global','GLOBAL','Global')
        call NWM_ESMF_NclScriptWrite(gridFile, &
          map=NWM_ESMF_MAPPRESET_GLOBAL, title=title, nclFile=nclFile, &
          uniformRect=uniformRect, writeCorners=writeCorners, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      case ('conus','CONUS','Conus')
        call NWM_ESMF_NclScriptWrite(gridFile, &
          map=NWM_ESMF_MAPPRESET_CONUS, title=title, nclFile=nclFile, &
          uniformRect=uniformRect, writeCorners=writeCorners, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      case ('irene','IRENE','Irene')
        call NWM_ESMF_NclScriptWrite(gridFile, &
          map=NWM_ESMF_MAPPRESET_IRENE, title=title, nclFile=nclFile, &
          uniformRect=uniformRect, writeCorners=writeCorners, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      case ('frontrange','FRONTRANGE','FrontRange')
        call NWM_ESMF_NclScriptWrite(gridFile, &
          map=NWM_ESMF_MAPPRESET_FRONTRANGE, title=title, nclFile=nclFile, &
          uniformRect=uniformRect, writeCorners=writeCorners, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      case default
        call ESMF_LogSetError(rcToCheck=ESMF_RC_ARG_VALUE,   &
...
#define METHOD "NWM_ESMF_NclScriptWrite"
!BOP
! !IROUTINE: NWM_ESMF_NclScriptWrite_default - Write NCL Script to file
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_NclScriptWrite
  subroutine NWM_ESMF_NclScriptWrite_default(gridFile, map, title, &
...
#define METHOD "NWM_ESMF_FerretScriptWrite"
!BOP
! !IROUTINE: NWM_ESMF_FerretScriptWrite_coords - Write Ferret Script to file
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FerretScriptWrite
  subroutine NWM_ESMF_FerretScriptWrite_coords(varName, dataFile, &
...
!EOP
  !-----------------------------------------------------------------------------
    ...
    call NWM_ESMF_FerretScriptWrite(varName,dataFile,gridFile,slices, &
...
#define METHOD "NWM_ESMF_FerretScriptWrite"
!BOP
! !IROUTINE: NWM_ESMF_FerretScriptWrite_preset - Write Ferret Script to file
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FerretScriptWrite
  subroutine NWM_ESMF_FerretScriptWrite_preset(varName, dataFile, &
...
!EOP
  !-----------------------------------------------------------------------------
    ...
    select case (trim(mapPreset))
      case ('global','GLOBAL','Global')
        call NWM_ESMF_FerretScriptWrite(varName, dataFile, gridFile, slices, &
          map=NWM_ESMF_MAPPRESET_GLOBAL, scale=scale, jnlFile=jnlFile, &
          uniformRect=uniformRect, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      case ('conus','CONUS','Conus')
        call NWM_ESMF_FerretScriptWrite(varName, dataFile, gridFile, slices, &
          map=NWM_ESMF_MAPPRESET_CONUS, scale=scale, jnlFile=jnlFile, &
          uniformRect=uniformRect, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      case ('irene','IRENE','Irene')
        call NWM_ESMF_FerretScriptWrite(varName, dataFile, gridFile, slices, &
          map=NWM_ESMF_MAPPRESET_IRENE, scale=scale, jnlFile=jnlFile, &
          uniformRect=uniformRect, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      case ('frontrange','FRONTRANGE','FrontRange')
        call NWM_ESMF_FerretScriptWrite(varName, dataFile, gridFile, slices, &
          map=NWM_ESMF_MAPPRESET_FRONTRANGE, scale=scale, jnlFile=jnlFile, &
          uniformRect=uniformRect, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      case default
        call ESMF_LogSetError(rcToCheck=ESMF_RC_ARG_VALUE,   &
...
#define METHOD "NWM_ESMF_FerretScriptWrite"
!BOP
! !IROUTINE: NWM_ESMF_FerretScriptWrite_default - Write Ferret Script to file
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FerretScriptWrite
  subroutine NWM_ESMF_FerretScriptWrite_default(varName, dataFile, gridFile, &
...
#define METHOD "NWM_ESMF_FieldFill"
!BOP
! !IROUTINE: NWM_ESMF_FieldFill - Fill data into a Field
! !INTERFACE:
  subroutine NWM_ESMF_FieldFill(field, keywordEnforcer, &
...
#define METHOD "NWM_ESMF_FillState"
!BOP
! !IROUTINE: NWM_ESMF_FillState_I4 - Fill data into State
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillState
  subroutine NWM_ESMF_FillState_I4(state,value,rc)
! ! ARGUMENTS
  ...
  !-----------------------------------------------------------------------------
    ...
    do iIndex = 1, itemCount
      if ( itemTypeList(iIndex) == ESMF_STATEITEM_FIELD) then
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        call NWM_ESMF_FillField(field,value=value,rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      endif
    enddo
...
#define METHOD "NWM_ESMF_FillState"
!BOP
! !IROUTINE: NWM_ESMF_FillState_I8 - Fill data into State
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillState
  subroutine NWM_ESMF_FillState_I8(state,value,rc)
! ! ARGUMENTS
    type(ESMF_State), intent(in)                :: state
...
#define METHOD "NWM_ESMF_FillState"
!BOP
! !IROUTINE: NWM_ESMF_FillState_R4 - Fill data into State
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillState
  subroutine NWM_ESMF_FillState_R4(state,value,rc)
! ! ARGUMENTS
    type(ESMF_State), intent(in)                :: state
...
#define METHOD "NWM_ESMF_FillState"
!BOP
! !IROUTINE: NWM_ESMF_FillState_R8 - Fill data into State
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillState
  subroutine NWM_ESMF_FillState_R8(state,value,rc)
! ! ARGUMENTS
    type(ESMF_State), intent(in)                :: state
...
#define METHOD "NWM_ESMF_FillState"
!BOP
! !IROUTINE: NWM_ESMF_FillState_SCHEME - Fill data into State
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillState
  subroutine NWM_ESMF_FillState_SCHEME(state,dataFillScheme,step,rc)
! ! ARGUMENTS
    type(ESMF_State), intent(in)                :: state
...
#define METHOD "NWM_ESMF_FillFieldBundle"
!BOP
! !IROUTINE: NWM_ESMF_FillFieldBundle_I4 - Fill data into FieldBundle
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillFieldBundle
  subroutine NWM_ESMF_FillFieldBundle_I4(fieldbundle,value,rc)
! ! ARGUMENTS
...
#define METHOD "NWM_ESMF_FillFieldBundle"
!BOP
! !IROUTINE: NWM_ESMF_FillFieldBundle_I8 - Fill data into FieldBundle
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillFieldBundle
  subroutine NWM_ESMF_FillFieldBundle_I8(fieldbundle,value,rc)
! ! ARGUMENTS
    type(ESMF_FieldBundle), intent(in)          :: fieldbundle
    integer(ESMF_KIND_I8),intent(in)            :: value
    integer, intent(out),optional               :: rc
...
#define METHOD "NWM_ESMF_FillFieldBundle"
!BOP
! !IROUTINE: NWM_ESMF_FillFieldBundle_R4 - Fill data into FieldBundle
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillFieldBundle
  subroutine NWM_ESMF_FillFieldBundle_R4(fieldbundle,value,rc)
! ! ARGUMENTS
    type(ESMF_FieldBundle), intent(in)          :: fieldbundle
    real(ESMF_KIND_R4),intent(in)               :: value
    integer, intent(out),optional               :: rc
...
#define METHOD "NWM_ESMF_FillFieldBundle"
!BOP
! !IROUTINE: NWM_ESMF_FillFieldBundle_R8 - Fill data into FieldBundle
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillFieldBundle
  subroutine NWM_ESMF_FillFieldBundle_R8(fieldbundle,value,rc)
! ! ARGUMENTS
    type(ESMF_FieldBundle), intent(in)          :: fieldbundle
    real(ESMF_KIND_R8),intent(in)               :: value
    integer, intent(out),optional               :: rc
...
#define METHOD "NWM_ESMF_FillFieldBundle"
!BOP
! !IROUTINE: NWM_ESMF_FillFieldBundle_SCHEME - Fill data into FieldBundle
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillFieldBundle
  subroutine NWM_ESMF_FillFieldBundle_SCHEME(fieldbundle,dataFillScheme,step,rc)
! ! ARGUMENTS
    type(ESMF_FieldBundle), intent(in)          :: fieldbundle
    character(len=*), intent(in)                :: dataFillScheme
    integer, intent(in), optional               :: step
...
#define METHOD "NWM_ESMF_FillField"
!BOP
! !IROUTINE: NWM_ESMF_FillField_I4 - Fill data into Field
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillField
  subroutine NWM_ESMF_FillField_I4(field,value,rc)
! ! ARGUMENTS
...
!EOP
  !-----------------------------------------------------------------------------
    ...
    call NWM_ESMF_FillArray(array,value=value,rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
...
#define METHOD "NWM_ESMF_FillField"
!BOP
! !IROUTINE: NWM_ESMF_FillField_I8 - Fill data into Field
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillField
  subroutine NWM_ESMF_FillField_I8(field,value,rc)
! ! ARGUMENTS
    type(ESMF_Field), intent(in)                :: field
    integer(ESMF_KIND_I8),intent(in)            :: value
    integer, intent(out),optional               :: rc
...
#define METHOD "NWM_ESMF_FillField"
!BOP
! !IROUTINE: NWM_ESMF_FillField_R4 - Fill data into Field
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillField
  subroutine NWM_ESMF_FillField_R4(field,value,rc)
! ! ARGUMENTS
    type(ESMF_Field), intent(in)                :: field
    real(ESMF_KIND_R4),intent(in)               :: value
    integer, intent(out),optional               :: rc
...
#define METHOD "NWM_ESMF_FillField"
!BOP
! !IROUTINE: NWM_ESMF_FillField_R8 - Fill data into Field
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillField
  subroutine NWM_ESMF_FillField_R8(field,value,rc)
! ! ARGUMENTS
    type(ESMF_Field), intent(in)                :: field
    real(ESMF_KIND_R8),intent(in)               :: value
    integer, intent(out),optional               :: rc
...
#define METHOD "NWM_ESMF_FillArray"
!BOP
! !IROUTINE: NWM_ESMF_FillArray_I4 - Fill data into Array
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillArray
  subroutine NWM_ESMF_FillArray_I4(array,value,rc)
! ! ARGUMENTS
...
#define METHOD "NWM_ESMF_FillArray"
!BOP
! !IROUTINE: NWM_ESMF_FillArray_I8 - Fill data into Array
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillArray
  subroutine NWM_ESMF_FillArray_I8(array,value,rc)
! ! ARGUMENTS
    type(ESMF_Array), intent(in)                :: array
    integer(ESMF_KIND_I8),intent(in)            :: value
    integer, intent(out),optional               :: rc
...
#define METHOD "NWM_ESMF_FillArray"
!BOP
! !IROUTINE: NWM_ESMF_FillArray_R4 - Fill data into Array
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillArray
  subroutine NWM_ESMF_FillArray_R4(array,value,rc)
! ! ARGUMENTS
    type(ESMF_Array), intent(in)                :: array
    real(ESMF_KIND_R4),intent(in)               :: value
    integer, intent(out),optional               :: rc
...
#define METHOD "NWM_ESMF_FillArray"
!BOP
! !IROUTINE: NWM_ESMF_FillArray_R8 - Fill data into Array
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_FillArray
  subroutine NWM_ESMF_FillArray_R8(array,value,rc)
! ! ARGUMENTS
    type(ESMF_Array), intent(in)                :: array
    real(ESMF_KIND_R8),intent(in)               :: value
    integer, intent(out),optional               :: rc
...
#define METHOD "NWM_ESMF_NetcdfIsPresent"
!BOP
! !IROUTINE: NWM_ESMF_NetcdfIsPresent - Check NetCDF file for varname
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_NetcdfIsPresent
  function NWM_ESMF_NetcdfIsPresent(varname,filename,rc)
! ! RETURN VALUE
    logical :: NWM_ESMF_NetcdfIsPresent
! ! ARGUMENTS
    character(len=*), intent(in)          :: varname
    character(len=*), intent(in)          :: filename
    integer, intent(out),optional         :: rc
...
!EOP
  !-----------------------------------------------------------------------------
    ...
    if(stat == nf90_NoErr) then
      NWM_ESMF_NetcdfIsPresent = .TRUE.
    elseif(stat == nf90_eNotVar) then
      NWM_ESMF_NetcdfIsPresent = .FALSE.
    else
      NWM_ESMF_NetcdfIsPresent = .FALSE.
...
#define METHOD "NWM_ESMF_NetcdfReadIXJX_Field"
!BOP
! !IROUTINE: NWM_ESMF_NetcdfReadIXJX_Field - Read NetCDF var into ESMF field
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_NetcdfReadIXJX
  subroutine NWM_ESMF_NetcdfReadIXJX_Field(varname,filename,start,field,rc)
! ! ARGUMENTS
    character(len=*), intent(in)          :: varname
    character(len=*), intent(in)          :: filename
...
!EOP
  !-----------------------------------------------------------------------------
    ...
    call NWM_ESMF_NetcdfReadIXJX(varname,filename,start,array=array,rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
...
#define METHOD "NWM_ESMF_NetcdfReadIXJX_Array"
!BOP
! !IROUTINE: NWM_ESMF_NetcdfReadIXJX_Array - Read NetCDF var into ESMF array
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_NetcdfReadIXJX
  subroutine NWM_ESMF_NetcdfReadIXJX_Array(varname,filename,start,array,rc)
! ! ARGUMENTS
    character(len=*), intent(in)          :: varname
    character(len=*), intent(in)          :: filename
    integer,intent(in)                    :: start(2)
    ...
    if (rank == 2) then
      if (typekind == ESMF_TYPEKIND_I4) then
        do deIndex=0,localDeCount-1
          call ESMF_ArrayGet(array,farrayPtr=farray_I42D,localDe=deIndex,rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
          call NWM_ESMF_NetcdfReadIXJX(varname,filename,start,farray=farray_I42D, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        enddo
      elseif (typekind == ESMF_TYPEKIND_I8) then
        do deIndex=0,localDeCount-1
          call ESMF_ArrayGet(array,farrayPtr=farray_I82D,localDe=deIndex,rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
          call NWM_ESMF_NetcdfReadIXJX(varname,filename,start,farray=farray_I82D, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        enddo
      elseif (typekind == ESMF_TYPEKIND_R4) then
        do deIndex=0,localDeCount-1
          call ESMF_ArrayGet(array,farrayPtr=farray_R42D,localDe=deIndex,rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
          call NWM_ESMF_NetcdfReadIXJX(varname,filename,start,farray=farray_R42D, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        enddo
      elseif (typekind == ESMF_TYPEKIND_R8) then
        do deIndex=0,localDeCount-1
          call ESMF_ArrayGet(array,farrayPtr=farray_R82D,localDe=deIndex,rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
          call NWM_ESMF_NetcdfReadIXJX(varname,filename,start,farray=farray_R82D, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        enddo
      else
        call ESMF_LogSetError(rcToCheck=ESMF_RC_ARG_RANK,   &
...
#define METHOD "NWM_ESMF_NetcdfReadIXJX_I4"
!BOP
! !IROUTINE: NWM_ESMF_NetcdfReadIXJX_I4 - Read NetCDF variable into I4 array
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_NetcdfReadIXJX
  subroutine NWM_ESMF_NetcdfReadIXJX_I4(varname,filename,start,farray,rc)
! ! ARGUMENTS
    character(len=*), intent(in)          :: varname
    character(len=*), intent(in)          :: filename
    integer,intent(in)                    :: start(2)
...
#define METHOD "NWM_ESMF_NetcdfReadIXJX_I8"
!BOP
! !IROUTINE: NWM_ESMF_NetcdfReadIXJX_I8 - Read NetCDF variable into I8 array
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_NetcdfReadIXJX
  subroutine NWM_ESMF_NetcdfReadIXJX_I8(varname,filename,start,farray,rc)
! ! ARGUMENTS
    character(len=*), intent(in)          :: varname
    character(len=*), intent(in)          :: filename
    integer,intent(in)                    :: start(2)
...
#define METHOD "NWM_ESMF_NetcdfReadIXJX_R4"
!BOP
! !IROUTINE: NWM_ESMF_NetcdfReadIXJX_R4 - Read NetCDF variable into R4 array
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_NetcdfReadIXJX
  subroutine NWM_ESMF_NetcdfReadIXJX_R4(varname,filename,start,farray,rc)
! ! ARGUMENTS
    character(len=*), intent(in)          :: varname
    character(len=*), intent(in)          :: filename
    integer,intent(in)                    :: start(2)
...
#define METHOD "NWM_ESMF_NetcdfReadIXJX_R8"
!BOP
! !IROUTINE: NWM_ESMF_NetcdfReadIXJX_R8 - Read NetCDF variable into R8 array
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_NetcdfReadIXJX
  subroutine NWM_ESMF_NetcdfReadIXJX_R8(varname,filename,start,farray,rc)
! ! ARGUMENTS
    character(len=*), intent(in)          :: varname
    character(len=*), intent(in)          :: filename
    integer,intent(in)                    :: start(2)
...
#define METHOD "NWM_ESMF_LogStateList"
!BOP
! !IROUTINE: NWM_ESMF_LogStateList - Write ESMF state information to PET Logs
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogStateList
  subroutine NWM_ESMF_LogStateList(stateList,nestedFlag,label,rc)
! ! ARGUMENTS
...
!EOP
  !-----------------------------------------------------------------------------
    ...
    if (present(label)) then
      ...
      llabel = 'NWM_ESMF_LogStateList'
    endif

    do sIndex=1, size(stateList)
      call NWM_ESMF_LogState(stateList(sIndex),nestedFlag,label,rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
    enddo
...
#define METHOD "NWM_ESMF_LogState"
!BOP
! !IROUTINE: NWM_ESMF_LogState - Write ESMF state information to PET Logs
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogState
  subroutine NWM_ESMF_LogState(state,nestedFlag,label,fvalues,rc)
! ! ARGUMENTS
    type(ESMF_State),intent(in)  :: state
    logical,intent(in),optional  :: nestedFlag
...
#define METHOD "NWM_ESMF_LogFieldConnections"
!BOP
! !IROUTINE: NWM_ESMF_LogFieldConnections - Write ESMF state connection to logs
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFieldConnections
  subroutine NWM_ESMF_LogFieldConnections(state,nestedFlag,label,rc)
! ! ARGUMENTS
    type(ESMF_State), intent(in)            :: state
    logical, intent(in), optional           :: nestedFlag
    character(len=*), intent(in), optional  :: label
...
!EOP
  !-----------------------------------------------------------------------------
    ...
    if(present(label)) then
      ...
      llabel = 'NWM_ESMF_LogFieldConnections '//trim(stateName)
    endif
...
#define METHOD "NWM_ESMF_LogGrid"
!BOP
! !IROUTINE: NWM_ESMF_LogGrid - Write ESMF grid information to PET logs
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogGrid
  subroutine NWM_ESMF_LogGrid(grid,label,rc)
! ! ARGUMENTS
    type(ESMF_Grid), intent(in)            :: grid
    character(len=*), intent(in), optional :: label
    integer, intent(out), optional         :: rc
...
#define METHOD "NWM_ESMF_LogFieldList"
!BOP
! !IROUTINE: NWM_ESMF_LogFieldList - Write ESMF field information to PET logs
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFieldList
  subroutine NWM_ESMF_LogFieldList(fieldList,label,rc)
! ! ARGUMENTS
...
!EOP
  !-----------------------------------------------------------------------------
    ...
    if (present(label)) then
      ...
      llabel = 'NWM_ESMF_LogFieldList'
    endif

    do fIndex=1,size(fieldList)
      call NWM_ESMF_LogField(fieldList(fIndex),llabel,rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
    enddo
...
#define METHOD "NWM_ESMF_LogField"
!BOP
! !IROUTINE: NWM_ESMF_LogField - Write ESMF field information to PET logs
! !INTERFACE:
  ! call using generic interface: ??
  subroutine NWM_ESMF_LogField(field,label,rc)
! ! ARGUMENTS
    type(ESMF_Field)                     :: field
    character(len=*),intent(in),optional :: label
    integer,intent(out),optional         :: rc
...
#define METHOD "NWM_ESMF_LogFieldLclVal"
!BOP
! !IROUTINE: NWM_ESMF_LogFieldLclVal - Write ESMF field local vals to PET logs
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFieldLclVal
  subroutine NWM_ESMF_LogFieldLclVal(field, label, rc)
! ! ARGUMENTS
    type(ESMF_Field), intent(in)            :: field
    character(len=*), intent(in), optional  :: label
    integer, intent(out), optional          :: rc
...
!EOP
  !-----------------------------------------------------------------------------
    ...
    if (present(label)) then
      ...
      llabel = "NWM_ESMF_LogFieldLclVal"
    endif

    call ESMF_FieldGet(field,array=array,name=fieldName,rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out    

    call NWM_ESMF_LogArrayLclVal(array,fieldName=fieldName,label=llabel,rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
...
#define METHOD "NWM_ESMF_LogArrayLclVal"
!BOP
! !IROUTINE: NWM_ESMF_LogArrayLclVal - Write ESMF array local vals to PET logs
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogArrayLclVal
  subroutine NWM_ESMF_LogArrayLclVal(array, fieldName, label, rc)
! ! ARGUMENTS
    type(ESMF_Array), intent(in)            :: array
...
!EOP
  !-----------------------------------------------------------------------------
    ...
    if (present(label)) then
      ...
      llabel = "NWM_ESMF_LogArrayLclVal"
    endif
    ...
    if (typekind == ESMF_TYPEKIND_I4) then
      if (rank == 1) then
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        call NWM_ESMF_LogFarrayLclVal(dataPtr_I4_1D, fieldName=fieldName, &
          label=trim(llabel), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      elseif (rank == 2) then
        call ESMF_ArrayGet(array, farrayPtr=dataPtr_I4_2D, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        call NWM_ESMF_LogFarrayLclVal(dataPtr_I4_2D, fieldName=fieldName, &
          label=trim(llabel), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      elseif (rank == 3) then
        call ESMF_ArrayGet(array, farrayPtr=dataPtr_I4_3D, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        call NWM_ESMF_LogFarrayLclVal(dataPtr_I4_3D, fieldName=fieldName, &
          label=trim(llabel), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      else
    ...
    elseif (typekind == ESMF_TYPEKIND_I8) then
      if (rank == 1) then
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        call NWM_ESMF_LogFarrayLclVal(dataPtr_I8_1D, fieldName=fieldName, &
          label=trim(llabel), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      elseif (rank == 2) then
        call ESMF_ArrayGet(array, farrayPtr=dataPtr_I8_2D, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        call NWM_ESMF_LogFarrayLclVal(dataPtr_I8_2D, fieldName=fieldName, &
          label=trim(llabel), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      elseif (rank == 3) then
        call ESMF_ArrayGet(array, farrayPtr=dataPtr_I8_3D, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        call NWM_ESMF_LogFarrayLclVal(dataPtr_I8_3D, fieldName=fieldName, &
          label=trim(llabel), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      else
    ...
    elseif (typekind == ESMF_TYPEKIND_R4) then
      if (rank == 1) then
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        call NWM_ESMF_LogFarrayLclVal(dataPtr_R4_1D, fieldName=fieldName, &
          label=trim(llabel), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      elseif (rank == 2) then
        call ESMF_ArrayGet(array, farrayPtr=dataPtr_R4_2D, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        call NWM_ESMF_LogFarrayLclVal(dataPtr_R4_2D, fieldName=fieldName, &
          label=trim(llabel), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      elseif (rank == 3) then
        call ESMF_ArrayGet(array, farrayPtr=dataPtr_R4_3D, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        call NWM_ESMF_LogFarrayLclVal(dataPtr_R4_3D, fieldName=fieldName, &
          label=trim(llabel), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      else
        call ESMF_LogWrite(trim(llabel)//" rank out of log utility range.", &
    ...
    elseif (typekind == ESMF_TYPEKIND_R8) then
      if (rank == 1) then
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        call NWM_ESMF_LogFarrayLclVal(dataPtr_R8_1D, fieldName=fieldName, &
          label=trim(llabel), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      elseif (rank == 2) then
        call ESMF_ArrayGet(array, farrayPtr=dataPtr_R8_2D, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        call NWM_ESMF_LogFarrayLclVal(dataPtr_R8_2D, fieldName=fieldName, &
          label=trim(llabel), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      elseif (rank == 3) then
        call ESMF_ArrayGet(array, farrayPtr=dataPtr_R8_3D, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
        call NWM_ESMF_LogFarrayLclVal(dataPtr_R8_3D, fieldName=fieldName, &
          label=trim(llabel), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, PASSTHRU)) return  ! bail out
      else
        call ESMF_LogWrite(trim(llabel)//" rank out of log utility range.", &
...
#define METHOD "NWM_ESMF_LogFarrayLclVal_I41D"
!BOP
! !IROUTINE: NWM_ESMF_LogFarrayLclVal_I41D - Write I41D array local vals to log
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFarrayLclVal
  subroutine NWM_ESMF_LogFarrayLclVal_I41D(farray, fieldName, label, rc)
! ! ARGUMENTS
  ...
  !-----------------------------------------------------------------------------
    ...
    if (present(label)) then
      ...
      if (present(fieldName)) then
        llabel = "NWM_ESMF_LogFarrayLclVal"//" "//trim(fieldName)
      else
        llabel = "NWM_ESMF_LogFarrayLclVal"
      endif
    endif
...
#define METHOD "NWM_ESMF_LogFarrayLclVal_I42D"
!BOP
! !IROUTINE: NWM_ESMF_LogFarrayLclVal_I42D - Write I42D array local vals to log
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFarrayLclVal
  subroutine NWM_ESMF_LogFarrayLclVal_I42D(farray, fieldName, label, rc)
! ! ARGUMENTS
    integer(ESMF_KIND_I4),intent(in)           :: farray(:,:)
    character(len=*), intent(in), optional     :: fieldName
    character(len=*), intent(in), optional     :: label
...
#define METHOD "NWM_ESMF_LogFarrayLclVal_I43D"
!BOP
! !IROUTINE: NWM_ESMF_LogFarrayLclVal_I43D - Write I43D array local vals to log
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFarrayLclVal
  subroutine NWM_ESMF_LogFarrayLclVal_I43D(farray, fieldName, label, rc)
! ! ARGUMENTS
    integer(ESMF_KIND_I4),intent(in)           :: farray(:,:,:)
    character(len=*), intent(in), optional     :: fieldName
    character(len=*), intent(in), optional     :: label
...
#define METHOD "NWM_ESMF_LogFarrayLclVal_I81D"
!BOP
! !IROUTINE: NWM_ESMF_LogFarrayLclVal_I81D - Write I81D array local vals to log
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFarrayLclVal
  subroutine NWM_ESMF_LogFarrayLclVal_I81D(farray, fieldName, label, rc)
! ! ARGUMENTS
...
#define METHOD "NWM_ESMF_LogFarrayLclVal_I82D"
!BOP
! !IROUTINE: NWM_ESMF_LogFarrayLclVal_I82D - Write I82D array local vals to log
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFarrayLclVal
  subroutine NWM_ESMF_LogFarrayLclVal_I82D(farray, fieldName, label, rc)
! ! ARGUMENTS
    integer(ESMF_KIND_I8),intent(in)           :: farray(:,:)
    character(len=*), intent(in), optional     :: fieldName
    character(len=*), intent(in), optional     :: label
...
#define METHOD "NWM_ESMF_LogFarrayLclVal_I83D"
!BOP
! !IROUTINE: NWM_ESMF_LogFarrayLclVal_I83D - Write I83D array local vals to log
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFarrayLclVal
  subroutine NWM_ESMF_LogFarrayLclVal_I83D(farray, fieldName, label, rc)
! ! ARGUMENTS
    integer(ESMF_KIND_I8),intent(in)           :: farray(:,:,:)
    character(len=*), intent(in), optional     :: fieldName
    character(len=*), intent(in), optional     :: label
...
#define METHOD "NWM_ESMF_LogFarrayLclVal_R41D"
!BOP
! !IROUTINE: NWM_ESMF_LogFarrayLclVal_R41D - Write R41D array local vals to log
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFarrayLclVal
  subroutine NWM_ESMF_LogFarrayLclVal_R41D(farray, fieldName, label, rc)
! ! ARGUMENTS
...
#define METHOD "NWM_ESMF_LogFarrayLclVal_R42D"
!BOP
! !IROUTINE: NWM_ESMF_LogFarrayLclVal_R42D - Write R42D array local vals to log
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFarrayLclVal
  subroutine NWM_ESMF_LogFarrayLclVal_R42D(farray, fieldName, label, rc)
! ! ARGUMENTS
    real(ESMF_KIND_R4),intent(in)           :: farray(:,:)
    character(len=*), intent(in), optional  :: fieldName
    character(len=*), intent(in), optional  :: label
...
#define METHOD "NWM_ESMF_LogFarrayLclVal_R43D"
!BOP
! !IROUTINE: NWM_ESMF_LogFarrayLclVal_R43D - Write R43D array local vals to log
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFarrayLclVal
  subroutine NWM_ESMF_LogFarrayLclVal_R43D(farray, fieldName, label, rc)
! ! ARGUMENTS
    real(ESMF_KIND_R4),intent(in)           :: farray(:,:,:)
    character(len=*), intent(in), optional  :: fieldName
    character(len=*), intent(in), optional  :: label
...
#define METHOD "NWM_ESMF_LogFarrayLclVal_R81D"
!BOP
! !IROUTINE: NWM_ESMF_LogFarrayLclVal_R81D - Write R81D array local vals to log
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFarrayLclVal
  subroutine NWM_ESMF_LogFarrayLclVal_R81D(farray, fieldName, label, rc)
! ! ARGUMENTS
...
#define METHOD "NWM_ESMF_LogFarrayLclVal_R82D"
!BOP
! !IROUTINE: NWM_ESMF_LogFarrayLclVal_R82D - Write R82D array local vals to log
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFarrayLclVal
  subroutine NWM_ESMF_LogFarrayLclVal_R82D(farray, fieldName, label, rc)
! ! ARGUMENTS
    real(ESMF_KIND_R8),intent(in)           :: farray(:,:)
    character(len=*), intent(in), optional  :: fieldName
    character(len=*), intent(in), optional  :: label
...
#undef METHOD
#define METHOD "NWM_ESMF_LogFarrayLclVal_R83D"
!BOP
! !IROUTINE: NWM_ESMF_LogFarrayLclVal_R83D - Write R83D array local vals to log
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogFarrayLclVal
  subroutine NWM_ESMF_LogFarrayLclVal_R83D(farray, fieldName, label, rc)
! ! ARGUMENTS
    real(ESMF_KIND_R8),intent(in)           :: farray(:,:,:)
    character(len=*), intent(in), optional  :: fieldName
    character(len=*), intent(in), optional  :: label
...
#undef METHOD
#define METHOD "NWM_ESMF_LogCplList"
!BOP
! !IROUTINE: NWM_ESMF_LogCplList - Write ESMF CplList to PET logs
! !INTERFACE:
  ! call using generic interface: NWM_ESMF_LogCplList
  subroutine NWM_ESMF_LogCplList(cplcomp,label,rc)
! ! ARGUMENTS
...
!EOP
 ...
 !-----------------------------------------------------------------------------
#undef METHOD
#define METHOD "NWM_NEMS_Clock"
   
  subroutine NWM_NEMS_Clock(clock)
...
#ifdef DEBUG
    ! clock = ESMF_ClockCreate(timeStep, startTime, stopTime=stopTime, name="Clock 1", rc=rc)
    call ESMF_LogWrite(MODNAME//": entered "//METHOD, ESMF_LOGMSG_INFO)
#endif
    ...
    call ESMF_ClockGet(clock, &
         ...
         currSimTime=currSimTime, prevSimTime=prevSimTime, &
         calendar=calendar, calkindflag=calkindflag, timeZone=timeZone, &
         advanceCount=advanceCount, alarmCount=alarmCount, &
         direction=direction, name=cname, rc=rc)
   
    ! get the nems clock time step -> calculated is seconds
    call ESMF_TimeIntervalGet(timeStep, s=S, rc=rc)
    write(logMsg, *) "timeStep: ", S
    ...
    ! stop time
    call ESMF_TimeGet(stopTime, s=S, rc=rc)
    write(logMsg, *) "stopTime: ", S
    call ESMF_LogWrite(logMsg, ESMF_LOGMSG_INFO)

    ! run duration
    call ESMF_TimeIntervalGet(runDuration, s=S, rc=rc)
    write(logMsg, *) "runDuration: ", S
    call ESMF_LogWrite(logMsg, ESMF_LOGMSG_INFO)


    ! get the clock's final current time
    call ESMF_TimeGet(currTime, yy=YY, mm=MM, dd=DD, h=H, m=M, s=S, rc=rc)
    write(logMsg, *) "currentTime: ", YY, "/", MM, "/", DD, &
             " ", H, ":", M, ":", S
    call ESMF_LogWrite(logMsg, ESMF_LOGMSG_INFO)

    ! get the number of times the clock was advanced
    write(logMsg, *) "advancedCount: ", advanceCount, " times."
    call ESMF_LogWrite(logMsg, ESMF_LOGMSG_INFO)

#ifdef DEBUG
    call ESMF_LogWrite(MODNAME//": exited "//METHOD, ESMF_LOGMSG_INFO)
#endif
 ...
 !-----------------------------------------------------------------------------
#undef METHOD
#define METHOD "NWM_Clock"
! NWM_Clock - Clock activities for NWM execution time
  ! 
  subroutine NWM_Clock(start_date, time_step, total_time, label,rc)
! ! ARGUMENTS
  character(len=64) :: label, start_date
  integer           :: rc
  integer           :: time_step, total_time   ! TO DO
!
  !-----------------------------------------------------------------------------
    ...
    ! instantiate time_step, alarm times, start and stop times
    ...
    alarm(1) = ESMF_AlarmCreate(clock, &
               ringTime=alarmTime, name="NWM Exec Alarm", rc=rc)
    ...
    ! Advance clock and alarm processing
...
#define METHOD "NWM_VMPrint"
! printing ESMF stuff
SUBROUTINE NWM_VMPrint(vm)
  ...
  ! local variables
  integer:: rc
  integer:: localPet, petCount, peCount, esmf_comm, ssiId, vas
  character(len=ESMF_MAXSTR) :: logMsg
  ...
  call ESMF_VMGet(vm, localPet=localPet, petCount=petCount, &
                  peCount=peCount, mpiCommunicator=esmf_comm, rc=rc)

  write (logMsg,*) localPet, petCount, peCount,esmf_comm
  call ESMF_LogWrite(trim(logMsg), ESMF_LOGMSG_INFO)
  ...
  print *, "esmf communicator ", esmf_comm
...
!
SUBROUTINE NWM_ConfigPrint(config, label)
!  
...
!
  integer            :: count, rc
  character(len=64)  :: dlabel 
  character(ESMF_MAXPATHLEN) :: fn1, fn2, fn3, cvalue ! strings to be read
!
!  ESMF_ConfigFindNextLabel(config,label=label) 
